...
class AppStrings {
  ...
  static const _en = <String, String>{
    ...
    'hideWordAndReading': 'Hide word & reading',
    'showWordAndReading': 'Show word & reading',
    ...
    'ttsSettingsTile': 'Japanese Voice & TTS Settings',
    'ttsSettingsTileBody': 'Choose an offline character voice',
    'ttsSettingsBody':
        'Choose the character voice used for Japanese pronunciation.',
    'previewVoice': 'Preview voice',
    'ttsOfflineModelNote':
        'The first preview downloads the official offline voice model (about 130 MB). After setup, speech synthesis stays on your device.',
    'ttsModelUnavailable':
        'The offline voice model could not be prepared. Check your connection and try again.',
    'ttsVoiceClearFemale': 'Clear female voice',
    'ttsVoiceWarmFemale': 'Warm female voice',
    'ttsVoiceLightFemale': 'Light female voice',
    'ttsVoiceSoftFemale': 'Soft female voice',
    'ttsVoiceSoftMale': 'Soft male voice',
    'ttsVoiceCalmMale': 'Calm male voice',
    'ttsVolumeHint':
  ...
  static const _ko = <String, String>{
    ...
    'hideReading': '읽기 숨기기',
    'showReading': '읽기 보기',
    'hideWordAndReading': '단어와 읽기 숨기기',
    'showWordAndReading': '단어와 읽기 보기',
    'details': '단어 상세',
    'question': '문제',
    ...
    'ttsVolume': '발음 볼륨',
    'ttsSettings': '일본어 음성',
    'ttsSettingsTile': '일본어 음성 및 TTS 설정',
    'ttsSettingsTileBody': '오프라인 캐릭터 음성을 선택하세요',
    'ttsSettingsBody': '일본어 발음에 사용할 캐릭터 음성을 선택하세요.',
    'previewVoice': '음성 미리 듣기',
    'ttsOfflineModelNote':
        '처음 미리 들을 때 공식 오프라인 음성 모델(약 130MB)을 다운로드합니다. 설정 후에는 기기에서 음성을 생성합니다.',
    'ttsModelUnavailable': '오프라인 음성 모델을 준비하지 못했습니다. 연결을 확인한 후 다시 시도하세요.',
    'ttsVoiceClearFemale': '또렷한 여성 음성',
    'ttsVoiceWarmFemale': '따뜻한 여성 음성',
    'ttsVoiceLightFemale': '가벼운 여성 음성',
    'ttsVoiceSoftFemale': '부드러운 여성 음성',
    'ttsVoiceSoftMale': '부드러운 남성 음성',
    'ttsVoiceCalmMale': '차분한 남성 음성',
